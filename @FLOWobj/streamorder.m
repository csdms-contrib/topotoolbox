function OUT = streamorder(FD,WW)
...
%
%     streamorder returns the Strahler Stream Order based on an instance of
%     the FLOWobj (FD) and a stream grid (W). W is either a logical matrix
%     or a GRIDobj that contains a logical matrix, that has ones where
%     streams are and zeros elsewhere.
% 
%     The output S is a GRIDobj and contains the Strahler Order for each
%     cell. Non-channel cells are set to zero. 
%
